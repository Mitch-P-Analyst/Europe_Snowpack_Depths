...
app.layout = dbc.Container([
    ...
    dbc.Row([
        dbc.Col(html.Div(className="conclusion",children=[
            ...
            html.P("Alpine winter snowpack is declining, with statistically significant, strongest losses at high elevations in early winter/early spring, led by Italy, Slovenia and Austria. While aggregated summaries are exaggerated in core months and muted in fringe months compared to station-level medians."),
